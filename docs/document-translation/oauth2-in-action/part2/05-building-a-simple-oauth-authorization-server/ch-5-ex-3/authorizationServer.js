...
app.get("/authorize", function (req, res) {
    ...
    if (!client) {
        ...
        /*
         * 验证客户端请求的 `scope` 集合是否与客户端已注册的 `scope` 集合保持一致。
         */

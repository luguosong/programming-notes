...
public class SignHelloWorld {
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        ...
        //创建签章处理对象
        PdfSigner signer = new PdfSigner(reader, new FileOutputStream("code/topics/itext-signatures/src/main/resources/C2_01_SignHelloWorld/hello_signed.pdf"), new StampingProperties());
        signer

...
public class SignEmptyField {
    public static void main(String[] args) throws GeneralSecurityException, IOException {
        ...
        //创建签章处理对象
        PdfSigner signer = new PdfSigner(reader, new FileOutputStream("code/topics/itext-signatures/src/main/resources/C2_03_SignEmptyField/hello_signed.pdf"), new StampingProperties());
        signer

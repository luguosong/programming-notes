...
public class SignHelloWorldWithTempFile {
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        ks.load(new FileInputStream("code/topics/itext-signatures/src/main/resources/ks"), "12345678".toCharArray());
        ...
        PdfSigner signer = new PdfSigner(
                reader,
                new FileOutputStream("code/topics/itext-signatures/src/main/resources/C2_02_SignHelloWorldWithTempFile/hello_signed.pdf"),
                "code/topics/itext-signatures/src/main/resources/C2_02_SignHelloWorldWithTempFile",
